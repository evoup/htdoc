...
weburl = document.URL
ns = weburl.split("/")
installpath = ns[0]+"//"+ns[2]+"/"+ns[3]+"/" //这里就是aaa<BR>

mtDropDown.spacerGif = installpath+"images/x.gif"; 
mtDropDown.dingbatOn = installpath+"images/expand-1.gif"; 
mtDropDown.dingbatOff = installpath+"images/expand-0.gif"; 
...
var item = new mtDropDownItem(sText, sUrl, this,Starget);
...
var minY = 0;
var maxY = (window.innerHeight ? window.innerHeight : document.body.clientHeight) - parseInt(elmCache["clip"].style.height)+100;
...
if (_this.items[this._index].url) 
	...
	if(_this.items[this._index].url.indexOf('?')>0)
			{
				window.open( _this.items[this._index].url+'&time='+expdate.getFullYear()+'-'+ expdate.getMonth()+expdate.getDate()+'-'+expdate.getHours()+'-'+ expdate.getMinutes()+'-'+ expdate.getMilliseconds(), _this.items[this._index].target );
			}
			else
			{
				window.open( _this.items[this._index].url+'?time='+expdate.getFullYear()+'-'+ expdate.getMonth()+expdate.getDate()+'-'+expdate.getHours()+'-'+ expdate.getMinutes()+'-'+ expdate.getMilliseconds(), _this.items[this._index].target );		
...
function mtDropDownItem(sText, sUrl, oParent,Starget) {
this.toString = toString;
this.text = sText;
this.url = sUrl;
...
return '<tr class="item"><td><img src="'+installpath+'images/headline.gif"></td><td nowrap style="' + sPaddingLeft + '">' + 
