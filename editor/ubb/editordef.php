...
$editorjs=<<<eot
<script type="text/javascript" src="ubbeditor.js"></script>
...
echo "<body onload=init_ubb (\'content\');>";
?>
<body onload="init_ubb('content')";>
<?php

$editorbody=<<<eot
<a href="JavaScript: void(0); "><IMG border=0 onclick=bold() title="{$lna[681]}" src="images/bold.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=italicize() title="{$lna[682]}" src="images/italic.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=underline() title="{$lna[683]}" src="images/underline.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=strike() title="{$lna[684]}" src="images/strikethrough.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=subsup('sup') title="{$lna[685]}" src="images/superscript.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=subsup('sub') title="{$lna[686]}" src="images/subscript.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=center() title="{$lna[687]}" src="images/center.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=hyperlink() title="{$lna[688]}" src="images/url.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=email() title="{$lna[689]}" src="images/email.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=image() title="{$lna[690]}" src="images/insertimage.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="addmedia('swf');" title="{$lna[691]}" src="images/swf.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="addmedia('wmp');" title="{$lna[692]}" src="images/wmp.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="addmedia('real');" title="{$lna[693]}" src="images/real.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=showcode() title="{$lna[694]}" src="images/code.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick=quoteme() title="{$lna[695]}" src="images/quote.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="addacronym();" title="{$lna[696]}" src="images/acronym.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="AddText('[hr]')" title="{$lna[697]}" src="images/line.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="addfile();" title="{$lna[698]}" src="images/file.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="addsfile();" title="{$lna[699]}" src="images/sfile.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="showemot()" title="{$lna[700]}" src="images/insertsmile.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="AddText('[separator]')" title="{$lna[701]}" src="images/separator.gif" ></a>
<a href="JavaScript: void(0); "><IMG border=0 onclick="AddText('[newpage]')" title="{$lna[702]}" src="images/newpage.gif" ></a>
<script type="text/javascript">
if (is_firefox) {
	document.write("<a href='JavaScript: void(0); '><IMG border=0 onclick='undo_fx();' title='{$lna[703]}' src='images/undo.gif' ></a>");
}
</script>
<br>
...
[<a href="javascript: toggle_upload();">{$lna[741]}</a>]
