...
function dbClass($username,$password,$database,$hostname="localhost",$is_utf8=0)
{GLOBAL $is_debug;
...
$this->link=mysql_connect($this->hostname,$this->username,$this->password) or die("Sorry,can not connect to database-_-!");
return $this->link;
}
...
if ($this->is_utf8){$sql=$this->gb2utf8($sql);}
...
function gb2utf8($sql){
return mb_convert_encoding($sql, "utf-8","gb2312"); 
}
