...
$sec_path = "/include/class_access_user/"; // a second location where the scripts should be 
...
//define("START_PAGE", "/include/class_access_user/example.php");
define("START_PAGE", "/member/myindex.php");//我的控制台页
...
define("WEBMASTER_MAIL", "webmaster@akata2.vicp.net"); 
define("WEBMASTER_NAME", "webmaster"); 
define("ADMIN_MAIL", "evoex@126.com"); 
