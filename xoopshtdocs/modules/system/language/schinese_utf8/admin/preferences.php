...
define("_MD_AM_USEMYSESS","使用定制session");
...
define("_MD_AM_BANNERS","启用横幅广告");
define("_MD_AM_MYIP","您的IP地址");
define("_MD_AM_MYIPDSC","广告点按统计将忽略来自这个IP的浏览");
...
define("_MD_AM_IFUCANT","如果无法修改属性的话就必须手动修改文件。");
...
define('_MD_AM_INDEXFOLLOW', '导航，内容');
define('_MD_AM_NOINDEXFOLLOW', '无导航，内容');
define('_MD_AM_INDEXNOFOLLOW', '导航，无内容');
define('_MD_AM_NOINDEXNOFOLLOW', '无导航，无内容');
...
define("_MD_AM_LDAP_USERS_BYPASS", "不必进行LDAP验证的账户");
define("_MD_AM_LDAP_USERS_BYPASS_DESC", "使用XOOPS本身的验证方式");
