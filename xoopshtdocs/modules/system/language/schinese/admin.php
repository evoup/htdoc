<?php
// $Id: admin.php,v 1.1 2008/02/28 12:17:35 cvs Exp $
//%%%%%%	File Name  admin.php 	%%%%%
define('_MD_AM_DBUPDATED','数据库更新完成!');

define('_MD_AM_CONFIG','系统管理');
...
define('_MD_AM_RANK','等级管理');
define('_MD_AM_USER','编辑帐号');
define('_MD_AM_FINDUSER', '查找会员');
define('_MD_AM_PREF','偏好设置');
define('_MD_AM_VRSN','系统版本');
