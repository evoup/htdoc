<?php
// $Id: makedata.php,v 1.1 2008/02/28 12:17:14 cvs Exp $
//  ------------------------------------------------------------------------ //
...
function make_data(&$dbm, &$cm, $adminname, $adminpass, $adminmail, $language, $gruops){
	...
	$dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by <a href=\"http://xoops.org.cn\" target=\"_blank\">XOOPS</a> &copy; 2001-" . date('Y', time()) . " <a href=\"http://xoops.sourceforge.net/\" target=\"_blank\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
