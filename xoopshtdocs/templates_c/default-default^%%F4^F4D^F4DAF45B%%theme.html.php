<?php /* Smarty version 2.6.18, created on 2008-02-28 20:13:25
         compiled from D:/intranet/htdoc/xoopshtdocs/themes/default/theme.html */ ?>
...
" />
	...
	<!-- Rss -->
	<link rel="alternate" type="application/rss+xml" title="" href="<?php echo 'http://127.0.0.1/xoopshtdocs/backend.php'; ?>" />

	<!-- Favicon -->
	<link rel="shortcut icon" type="image/ico" href="<?php echo 'http://127.0.0.1/xoopshtdocs/favicon.ico'; ?>" />
	
    <!-- Sheet Css -->
	<link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://127.0.0.1/xoopshtdocs/xoops.css'; ?>" />
	<link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://127.0.0.1/xoopshtdocs/themes/default/style.css'; ?>" />
...
<table cellspacing="0">
<tr id="header">
	<td id="headerlogo"><a href="<?php echo 'http://127.0.0.1/xoopshtdocs/'; ?>"><img src="<?php 
echo 'http://127.0.0.1/xoopshtdocs/themes/default/logo.gif'; ?>" width="150px" height="80px" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>
